...
// $password = 'XWtooeasy28!';     
// $host = 'data-rainfall-293412:us-east4:cs4750-hooslistening';       // e.g., 'cs4750:us-east4:db-demo'; 
// $dbname = 'cs4750_project_hooslistening';           // e.g., 'guestbook';
// $dsn = "mysql:unix_socket=/cloudsql/data-rainfall-293412:us-east4:cs4750-hooslistening;
//       dbname=cs4750_project_hooslistening";
...
$host = 'data-rainfall-293412:us-east4:cs4750-hooslistening';       // e.g., 'cs4750:us-east4:db-demo'; 
$dbname = 'cs4750_project_hooslistening';           // e.g., 'guestbook';
$dsn = "mysql:host=34.150.161.171;dbname=$dbname";   // connect PHP (XAMPP) to DB (GCP)
